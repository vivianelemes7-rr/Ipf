...
const { verificarToken, verificarCadastroAdmin } = require('../middlewares/autorizacaoMiddleware');
...
router.post('/cadastrar-admin', rateLimit(3, 60000), verificarCadastroAdmin, validarCadastroAdmin, AutenticacaoController.cadastrarAdmin);
